...
namespace WizardEmporium.Store.Controller
{
    ...
    public class StoreController : BaseController
    {
        ...
        [HttpGet("All")]
        [ProducesResponseType(typeof(ValueResponse<IEnumerable<MagicItemDto>, StoreServiceResponseCode>), 200)]
        ...
        [HttpGet("Orders")]
        [ProducesResponseType(typeof(ValueResponse<IEnumerable<MagicItemOrderDto>, StoreServiceResponseCode>), 200)]
        [ProducesResponseType(typeof(ErrorResponse), 400)]
